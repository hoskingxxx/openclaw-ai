...
| **Hourly Cost** | $0 (but your time = $50/hr) | $0.50 - $3.00 |
...
- Your debugging time: [hours] × $50/hr = $[time cost]
...
<div itemScope itemType="https://schema.org/FAQPage">
  ...
  <div itemScope itemType="https://schema.org/Question" itemProp="mainEntity">
    ...
    <div itemScope itemType="https://schema.org/Answer" itemProp="acceptedAnswer">
      <p itemProp="text">
        <strong>A:</strong> Vultr cloud GPUs start at $0.50/hour for RTX 4090-class cards, and $1.50-$3.00/hour for H100/A100. You pay only for what you use.
      </p>
    </div>
  </div>
</div>

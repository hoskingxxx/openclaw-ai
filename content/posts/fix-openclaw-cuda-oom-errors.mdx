...
<a
  href="https://www.vultr.com/?ref=9863490&utm_source=openclaw&utm_medium=decision-gate&utm_content=cuda-oom-secondary-exit"
  target="_blank"
  ...
  data-umami-event-placement="decision-gate"
  data-umami-event-cta-id="cuda-oom-secondary-exit"
  data-umami-event-post="fix-openclaw-cuda-oom-errors"
>

...
*Context: This proves exactly why `JSON.parse` fails at "line 1 column 1" (because `<` is not an opening brace).*
...
> For a full breakdown of correct R1 parameters, check our **[DeepSeek R1 Configuration Guide](/guides/how-to-use-deepseek-with-openclaw)**.
...
2. **For Production Stability:**
   ...
   Parsing is just one hurdle. If your hardware is also struggling, see our **[CUDA OOM Fix Guide](/guides/fix-openclaw-cuda-oom-errors)**.

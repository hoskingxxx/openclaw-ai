...
> **Note:** DeepSeek is strict. If you see `Invalid JSON` errors in your logs, read our **[JSON Mode Fix Guide](/posts/fix-openclaw-json-mode-errors)** before you blame the model.
...
- **Cloud is for shipping.** I pay $0.50/hour to Vultr not because I love spending money, but because I hate segfaults.
...
> If you are already seeing memory crashes, check our **[CUDA OOM Fix Guide](/posts/fix-openclaw-cuda-oom-errors)** for the specific config tweaks to squeeze it into 8GB.

...
LLM_API_KEY="ollama"  # Dummy value, Ollama doesn't check
LLM_MODEL="deepseek-r1:8b"  # Or :1.5b if you're desperate
```

> **Reality Check:** The 1.5B version will work, but don't expect complex reasoning. It's good enough for simple file operations and basic tasks. The 8B version is the minimum for anything "smart".

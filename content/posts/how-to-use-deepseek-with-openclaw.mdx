...
| Model Variant | Approx VRAM Required | Reality |
| :--- | :--- | :--- |
| **R1 (Full Precision)** | 40GB+ | Will not run on consumer GPUs. |
| **R1 (FP16)** | ~32GB | Crashes or OOM on almost everything. |
| **R1 (8-bit)** | ~24GB | Barely usable on RTX 3090/4090, slow. |
| **R1 (4-bit quantized)** | ~16GB | Runs, but reasoning is degraded. |

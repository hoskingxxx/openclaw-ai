    ...
    <footer className="footer border-t border-white/10 mt-20">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* 文档 */}
          <div>
            <h4 className="text-text-primary font-semibold mb-4">文档</h4>
          ...
          {/* 工具 */}
          <div>
            <h4 className="text-text-primary font-semibold mb-4">工具</h4>
            <ul className="space-y-2">
              <li>
          ...
          {/* 官方链接 */}
          <div>
            <h4 className="text-text-primary font-semibold mb-4">官方</h4>
            <ul className="space-y-2">
              <li>
                <a
        ...
        <div className="mt-6 p-4 bg-background-tertiary/50 rounded-lg border border-white/5">
          <p className="text-xs text-text-tertiary leading-relaxed">
            <strong className="text-text-secondary">免责声明：</strong>
            本站为 OpenClaw 非官方中文资源站，内容仅供学习交流使用。
            OpenClaw 软件按 MIT 许可证开源，使用者需自行承担使用风险。
            本站不对因使用该软件而产生的任何损失承担责任。
          </p>
        </div>
      </div>
    </footer>

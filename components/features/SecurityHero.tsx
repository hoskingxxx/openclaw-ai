 ...
 * =====================================================
 * Uses PrimaryCTA for Cloud instead of hardcoded link
...
export function SecurityHero() {
  const handleVultrClick = () => {
    // Tracking handled by PrimaryCTA component
  }
    ...
    <section className="relative flex items-center justify-center py-20 bg-black min-h-[80vh]">
      ...
      <ContentRail>
        <ContentEdge className="relative z-10 text-center">
          ...
          <h2 className="text-2xl font-bold mb-8 text-center text-red-400 font-mono">
